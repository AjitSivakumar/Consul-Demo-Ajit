    ...
    slides: [
      {
        num: 1,
        label: 'Slide 01',
        title: 'Heat Exposure & Preterm Birth — Pilot Justification',
        bullets: [
          'Chen Lab × Tobin Center for Economic Policy',
          'New Haven low-income census tracts · June session brief',
          'Pre-peer-review · lower-bound framing',
        ],
        chips: [
          { text: 'RR ≈ 1.4', style: 'teal' },
          { text: 'Q3 · low-income tracts', style: 'blue' },
          { text: 'Pre-peer-review', style: 'gray' },
        ],
        status: 'resolved',
      },
      {
        num: 2,
        label: 'Slide 02',
        title: 'Effect Size by Stratum',
        bullets: ['Excess risk above baseline (RR − 1 × 100) · conservative lower bound shown'],
        miniChart: [
          { label: 'NH · low-income', value: 40, style: 'primary' },
          { label: 'NH · all tracts', value: 22, style: 'muted' },
          { label: 'Lower bound', value: 28, style: 'primary' },
          { label: 'Bridgeport', value: 14, style: 'muted' },
        ],
        status: 'resolved',
      },
      {
        num: 3,
        label: 'Slide 03',
        title: 'Geographic Scope — Evidence Quality',
        bullets: [
          'New Haven: census tract level · high confidence · anchor',
          'Bridgeport: sparse tracts · directional only · handle with care',
          'Statewide CT: aggregate · background context only',
        ],
        chips: [
          { text: 'New Haven — ANCHOR', style: 'teal' },
          { text: 'Bridgeport — DIRECTIONAL', style: 'gray' },
        ],
        status: 'resolved',
      },
      {
        num: 4,
        label: 'Slide 04',
        title: 'CT Stakeholder Pathway — DEEP → OPM → DPH',
        bullets: [
          'Entry: Adaptation Office (reports to DEEP)',
          'Funding: OPM — cool corridor capital allocation',
          'Compliance gate: DPH sign-off for maternal outcomes data',
          'Run sign-offs in parallel — do not serialize',
        ],
        chips: [
          { text: 'DEEP', style: 'blue' },
          { text: '→ OPM', style: 'blue' },
          { text: '→ DPH', style: 'blue' },
        ],
        status: 'resolved',
      },
      {
        num: 5,
        label: 'Slide 05',
        title: 'Economic Case — Lower Bound',
        bullets: [
          'NICHD direct cost: ~$50,000 per preterm birth',
          '10–20 prevented births per season = $500K–$1M',
          'Pilot scope: New Haven targeted census tracts',
          'Do NOT use city-wide projection — pre-peer-review',
        ],
        chips: [
          { text: '$50K / preterm birth', style: 'teal' },
          { text: 'Lower bound only', style: 'gray' },
        ],
        status: 'resolved',
      },
      {
        num: 6,
        label: 'Slide 06',
        title: 'Open Items Before June Session',
        bullets: [
          'AC confounder adjustment — revised RR pending',
          'Bridgeport estimates — peer review outcome',
          'OPM + DPH contacts — not yet identified',
        ],
        status: 'pending',
        pendingNote: 'AC adjustment & Bridgeport revision required before finalizing',
      },
    ],
    summary:
      'Slide deck ready for adaptation office briefing once AC confounder is resolved and DEEP/OPM/DPH contacts are confirmed. Use New Haven as the primary evidence anchor throughout — do not lead with Bridgeport.',
  },
